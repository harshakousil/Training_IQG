...
@Stateless(name = "SessionEJB11", mappedName = "Application11-SessionEJB11")
@Remote
@Local
public class SessionEJB11Bean implements SessionEJB11, SessionEJB11Local {
    @PersistenceContext(unitName="FOD")
    private EntityManager em;

    public SessionEJB11Bean() {
    }
