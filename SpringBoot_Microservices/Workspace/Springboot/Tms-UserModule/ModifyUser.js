...
export default function ModifyUser() {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:8765/user/roles')
      .then((response) => {
  ...
  const handleSearch = () => {
    ...
    axios
      .post('http://localhost:8765/user/get', { username: userName })
      .then((response) => {
  ...
  const handleRemove = () => {
    ...
    axios
      .delete('http://localhost:8765/user/deleteUser', {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .put('http://localhost:8765/user/modifyUser', modifiedUser)
      .then((response) => {
